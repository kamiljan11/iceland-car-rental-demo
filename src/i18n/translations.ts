...
export const translations = {
  ...
  hero: {
    ...
    title1: { en: "No hidden fees.", pl: "Bez ukrytych opłat.", is: "Engin falin gjöld." },
    title2: { en: "No surprises at pickup.", pl: "Bez niespodzianek przy odbiorze.", is: "Engar óvæntar uppákomur." },
    desc: {
      en: "Full insurance, free extras, and 24/7 roadside rescue included in every booking. Just drive.",
      pl: "Pełne ubezpieczenie, darmowe dodatki i pomoc drogowa 24/7 w cenie. Po prostu jedź.",
      is: "Full trygging, ókeypis aukahlutir og 24/7 vegabjörgun innifalin. Bara keyrðu.",
    },
  ...
  vehicles: {
    ...
    camper: {
      ...
      specs: { seats: 2, transmission: "manual" as const, fuel: "diesel" as const, luggage: 0, drivetrain: "2WD" },
    ...
    compact: {
      ...
      specs: { seats: 4, transmission: "automatic" as const, fuel: "petrol" as const, luggage: 2, drivetrain: "2WD" },
