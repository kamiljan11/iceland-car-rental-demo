...
export const translations = {
  ...
  vehicles: {
    ...
    offroad: {
      ...
      description: {
        en: "The ultimate F-road machine. Short wheelbase, high clearance, and low-range 4WD make river crossings feel routine. Compact enough for narrow mountain tracks. Comes with recovery gear and a spare tyre.",
        pl: "Maszyna stworzona na drogi F. Krótki rozstaw osi, wysoki prześwit i 4WD z reduktorem. Kompaktowy na wąskie górskie ścieżki. W zestawie sprzęt ratunkowy i zapasowa opona.",
        is: "Fullkominn F-vegabíll. Stuttur hjólgrunnur, hár næðingarhæð og 4WD lággildi gera vaðlög auðveld.",
      },
      features: {
      ...
      specs: { seats: 3, transmission: "manual" as const, fuel: "diesel" as const, luggage: 2, drivetrain: "4WD", engine: "1.5L Turbo", range: "600 km" },
    ...
    electric: {
      ...
      description: {
        en: "Drive Iceland guilt-free. 450km range covers the longest day drives with ease. Fast-charging in 30 min at 100+ stations across Iceland. AWD handles winter roads confidently. Heated seats and panoramic roof included.",
        pl: "Zwiedzaj Islandię ekologicznie. Zasięg 450km z łatwością pokrywa najdłuższe dzienne trasy. Szybkie ładowanie w 30 min na 100+ stacjach w Islandii. AWD radzi sobie zimą. Podgrzewane fotele i panoramiczny dach.",
        is: "Keyrðu um Ísland án sektarkenndar. 450km drægni nær auðveldlega yfir lengstu dagsferðir. Hraðhleðsla á 30 mín á 100+ stöðvum.",
      },
      features: {
      ...
      specs: { seats: 5, transmission: "automatic" as const, fuel: "electric" as const, luggage: 3, drivetrain: "AWD", engine: "Dual Motor EV", range: "450 km" },
    ...
    luxury: {
      ...
      description: {
        en: "First-class comfort on any road. Adaptive air suspension smooths even the roughest gravel. Panoramic roof for northern lights viewing. Meridian sound system, heated/cooled massage seats, and head-up display. F-road approved.",
        pl: "Komfort pierwszej klasy na każdej drodze. Adaptacyjne zawieszenie pneumatyczne wygładza nawet najtrudniejszy żwir. Panoramiczny dach do oglądania zorzy. System Meridian, podgrzewane/chłodzone fotele z masażem. Dozwolony na drogi F.",
        is: "Fyrsta flokks þægindi á öllum vegum. Aðlögunarhæft loftfjöðrun jafnar jafnvel grófustu malarvegi.",
      },
      features: {
        en: ["5 seats", "Diesel", "4WD"],
        pl: ["5 miejsc", "Diesel", "4WD"],
      ...
      specs: { seats: 5, transmission: "automatic" as const, fuel: "diesel" as const, luggage: 5, drivetrain: "4WD", engine: "3.0L V6 Diesel", range: "750 km" },
  ...
  cta: {
    ...
    title2: { en: "For Your Business?", pl: "Dla swojego biznesu?", is: "Fyrir þitt fyrirtæki?" },
    desc: {
      ...
      pl: "Tworzymy piękne, spersonalizowane strony internetowe dla pensjonatów, hoteli i firm turystycznych w Islandii. Wszystko zrobione za Ciebie — strona, zdjęcia, reklamy, social media. Jeden plan. Zero stresu.",
      is: "Við smíðum glæsilegar, sérsniðnar vefsíður fyrir gistihús, hótel og ferðaþjónustufyrirtæki á Íslandi. Allt gert fyrir þig — vefsíða, myndir, auglýsingar, samfélagsmiðlar. Eitt pakki. Enginn stress.",
    },
    features: {
      ...
      f3: { en: "Booking Integration", pl: "Integracja rezerwacji", is: "Bókunarsamþætting" },
      f4: { en: "All-In-One Plan", pl: "Plan All-In-One", is: "Allt-í-einu pakki" },
    },
